...
"""
This submodule provides the PDFLoad class for loading and splitting PDF files into text chunks
using PyMuPDFLoader and RecursiveCharacterTextSplitter, as well as a utility function for loading prompts from text files.
"""
...
def load_prompt(filename):
    ...
    Args:
        filename (str): Path to the text file to load.
